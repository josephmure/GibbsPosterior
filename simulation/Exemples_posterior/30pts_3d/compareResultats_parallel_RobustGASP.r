...
sparkR.session("spark://atfront1.athos.hpc.edf.fr:7077", appName="Evaluations")
...
if(NOMBRE_FONCTIONS_TENDANCE > 0) { #Cas du krigeage universel

if(REGULARITE == 5/2) {
OBJET_RGASP_xi <-rgasp(x_connus,y_connus,tendance,prior_choice="ref_xi") #### Attention, la regularite est par defaut supposee 5/2
OBJET_RGASP_gamma <-rgasp(x_connus,y_connus,tendance,prior_choice="ref_gamma") #### Attention, la regularite est par defaut supposee 5/2
OBJET_RGASP_approx <-rgasp(x_connus,y_connus,tendance,prior_choice="ref_approx") #### Attention, la regularite est par defaut supposee 5/2
}

if(REGULARITE == 3/2) {
OBJET_RGASP_xi <-rgasp(x_connus,y_connus,tendance,prior_choice="ref_xi", kernel_type = "matern_3_2")
OBJET_RGASP_gamma <-rgasp(x_connus,y_connus,tendance,prior_choice="ref_gamma", kernel_type = "matern_3_2")
OBJET_RGASP_approx <-rgasp(x_connus,y_connus,tendance,prior_choice="ref_approx", kernel_type = "matern_3_2")
}

if(REGULARITE == 1/2) {
OBJET_RGASP_xi <-rgasp(x_connus,y_connus,tendance,prior_choice="ref_xi", kernel_type = "matern_1_2")
OBJET_RGASP_gamma <-rgasp(x_connus,y_connus,tendance,prior_choice="ref_gamma", kernel_type = "matern_1_2")
OBJET_RGASP_approx <-rgasp(x_connus,y_connus,tendance,prior_choice="ref_approx", kernel_type = "matern_1_2")
}
} else { #Cas du krigeage simple apparemment desormais supporte par RobustGaSP (parametre zero.mean est un string par defaut == "No")

if(REGULARITE == 5/2) {
OBJET_RGASP_xi <-rgasp(x_connus,y_connus,prior_choice="ref_xi", zero.mean="Yes") #### Attention, la regularite est par defaut supposee 5/2
OBJET_RGASP_gamma <-rgasp(x_connus,y_connus,prior_choice="ref_gamma", zero.mean="Yes") #### Attention, la regularite est par defaut supposee 5/2
OBJET_RGASP_approx <-rgasp(x_connus,y_connus,prior_choice="ref_approx", zero.mean="Yes") #### Attention, la regularite est par defaut supposee 5/2
}

if(REGULARITE == 3/2) {
OBJET_RGASP_xi <-rgasp(x_connus,y_connus,prior_choice="ref_xi", kernel_type = "matern_3_2", zero.mean="Yes")
OBJET_RGASP_gamma <-rgasp(x_connus,y_connus,prior_choice="ref_gamma", kernel_type = "matern_3_2", zero.mean="Yes")
OBJET_RGASP_approx <-rgasp(x_connus,y_connus,prior_choice="ref_approx", kernel_type = "matern_3_2", zero.mean="Yes")
}

if(REGULARITE == 1/2) {
OBJET_RGASP_xi <-rgasp(x_connus,y_connus,prior_choice="ref_xi", kernel_type = "matern_1_2", zero.mean="Yes")
OBJET_RGASP_gamma <-rgasp(x_connus,y_connus,prior_choice="ref_gamma", kernel_type = "matern_1_2", zero.mean="Yes")
OBJET_RGASP_approx <-rgasp(x_connus,y_connus,prior_choice="ref_approx", kernel_type = "matern_1_2", zero.mean="Yes")
}
}


##INUTILE : je ne pense pas que la paramétrisation des longueurs de corrélation de M. Gu soit celle de F. Bachoc !
#LONGUEUR_CORRELATION_RobustGaSP_xi <- OBJET_RGASP_xi@beta_hat^(-1)
#LONGUEUR_CORRELATION_RobustGaSP_gamma <- OBJET_RGASP_gamma@beta_hat^(-1)
#LONGUEUR_CORRELATION_RobustGaSP_approx <- OBJET_RGASP_approx@beta_hat^(-1)
...
## !!!! RobustGaSP ne permet que les noyaux tensorises, donc on utilise des noyaux tensorises pour eux meme si TYPE_NOYAU_MATERN == "geometrique"
if(TYPE_NOYAU_MATERN == "geometrique") 
{
  ...
  #NOYAU_RobustGaSP_xi <- creeMaternTensorise(variance = 1, longueur = LONGUEUR_CORRELATION_RobustGaSP_xi, regularite = REGULARITE )
  #NOYAU_RobustGaSP_gamma <- creeMaternTensorise(variance = 1, longueur = LONGUEUR_CORRELATION_RobustGaSP_gamma, regularite = REGULARITE )
  #NOYAU_RobustGaSP_approx <- creeMaternTensorise(variance = 1, longueur = LONGUEUR_CORRELATION_RobustGaSP_approx, regularite = REGULARITE ) 
...
#MATRICE_RobustGaSP_xi <- creeMatriceCovariance(x1= x_connus, x2= x_connus, noyau= NOYAU_RobustGaSP_xi)
#MATRICE_RobustGaSP_xi_INVERSE <- solve(MATRICE_RobustGaSP_xi) ## Dommage qu'on ait a l'inverser, mais la matrice inverse intervient souvent, donc on n'a guere le choix.
#MATRICE_RobustGaSP_gamma <- creeMatriceCovariance(x1= x_connus, x2= x_connus, noyau= NOYAU_RobustGaSP_gamma)
...
#MATRICE_RobustGaSP_approx <- creeMatriceCovariance(x1= x_connus, x2= x_connus, noyau= NOYAU_RobustGaSP_approx)
#MATRICE_RobustGaSP_approx_INVERSE <- solve(MATRICE_RobustGaSP_approx) ## Dommage qu'on ait a l'inverser, mais la matrice inverse intervient souvent, donc on n'a guere le choix.
...
#MATRICE_RobustGaSP_xi_TOTALE <- creeMatriceCovariance(x1= Tous_les_points, x2= Tous_les_points, noyau= NOYAU_RobustGaSP_xi)
#CORREL_CONNUS_NOUVEAUX_RobustGaSP_xi <- creeMatriceCovariance(x1= x_connus, x2= Nouveaux_points, noyau= NOYAU_RobustGaSP_xi)
#MATRICE_RobustGaSP_gamma_TOTALE <- creeMatriceCovariance(x1= Tous_les_points, x2= Tous_les_points, noyau= NOYAU_RobustGaSP_gamma)
#CORREL_CONNUS_NOUVEAUX_RobustGaSP_gamma <- creeMatriceCovariance(x1= x_connus, x2= Nouveaux_points, noyau= NOYAU_RobustGaSP_gamma)
#MATRICE_RobustGaSP_approx_TOTALE <- creeMatriceCovariance(x1= Tous_les_points, x2= Tous_les_points, noyau= NOYAU_RobustGaSP_approx)
#CORREL_CONNUS_NOUVEAUX_RobustGaSP_approx <- creeMatriceCovariance(x1= x_connus, x2= Nouveaux_points, noyau= NOYAU_RobustGaSP_approx)
...
if(NOMBRE_FONCTIONS_TENDANCE>0){
  ...
  ##Ceci fait l'integralite de la prediction RobustGaSP en un coup.
  PRED_RGASP_xi <-  predict(OBJET_RGASP_xi,Nouveaux_points,TENDANCE_NOUVEAUX)
  PRED_RGASP_gamma <-  predict(OBJET_RGASP_gamma,Nouveaux_points,TENDANCE_NOUVEAUX)
  PRED_RGASP_approx <-  predict(OBJET_RGASP_approx,Nouveaux_points,TENDANCE_NOUVEAUX)
  ...
  #MATRICE_NOUVEAUX_RobustGaSP_xi <- 1 + TENDANCE_NOUVEAUX_CONNUS %*% MATRICE_RobustGaSP_xi %*% t(TENDANCE_NOUVEAUX_CONNUS) - TENDANCE_NOUVEAUX_CONNUS %*% CORREL_CONNUS_NOUVEAUX_RobustGaSP_xi - t(CORREL_CONNUS_NOUVEAUX_RobustGaSP_xi) %*% t(TENDANCE_NOUVEAUX_CONNUS)
  ...
  #MATRICE_NOUVEAUX_RobustGaSP_approx <- 1 + TENDANCE_NOUVEAUX_CONNUS %*% MATRICE_RobustGaSP_approx %*% t(TENDANCE_NOUVEAUX_CONNUS) - TENDANCE_NOUVEAUX_CONNUS %*% CORREL_CONNUS_NOUVEAUX_RobustGaSP_approx - t(CORREL_CONNUS_NOUVEAUX_RobustGaSP_approx) %*% t(TENDANCE_NOUVEAUX_CONNUS)
  ...
  #CORREL_CONNUS_NOUVEAUX_RobustGaSP_xi <- t(injectionOrthogonalTendance) %*% (MATRICE_RobustGaSP_xi %*% t(TENDANCE_NOUVEAUX_CONNUS) - CORREL_CONNUS_NOUVEAUX_RobustGaSP_xi)
  #CORREL_CONNUS_NOUVEAUX_RobustGaSP_gamma <- t(injectionOrthogonalTendance) %*% (MATRICE_RobustGaSP_gamma %*% t(TENDANCE_NOUVEAUX_CONNUS) - CORREL_CONNUS_NOUVEAUX_RobustGaSP_gamma)
  #CORREL_CONNUS_NOUVEAUX_RobustGaSP_approx <- t(injectionOrthogonalTendance) %*% (MATRICE_RobustGaSP_approx %*% t(TENDANCE_NOUVEAUX_CONNUS) - CORREL_CONNUS_NOUVEAUX_RobustGaSP_approx)
  ...
  Estimation_beta_RobustGaSP_xi  <- OBJET_RGASP_xi@theta_hat 
  Estimation_beta_RobustGaSP_gamma  <- OBJET_RGASP_gamma@theta_hat 
  Estimation_beta_RobustGaSP_approx  <- OBJET_RGASP_approx@theta_hat  
  ...
  Estimations_beta <- cbind(Estimation_beta_argmax_vraisemblance,Estimation_beta_mode_posterior,Estimation_beta_RobustGaSP_xi,Estimation_beta_RobustGaSP_gamma,Estimation_beta_RobustGaSP_approx)
  ...
  #MATRICE_RobustGaSP_xi_INJECTEE <- t(injectionOrthogonalTendance) %*% MATRICE_RobustGaSP_xi %*% injectionOrthogonalTendance
  #MATRICE_RobustGaSP_xi_INVERSE <- solve(MATRICE_RobustGaSP_xi_INJECTEE)
  ...
  #MATRICE_RobustGaSP_approx_INJECTEE <- t(injectionOrthogonalTendance) %*% MATRICE_RobustGaSP_approx %*% injectionOrthogonalTendance
  #MATRICE_RobustGaSP_approx_INVERSE <- solve(MATRICE_RobustGaSP_approx_INJECTEE)
  ...
  ##Ceci fait l'integralite de la prediction RobustGaSP en un coup.
  PRED_RGASP_xi <-  predict(OBJET_RGASP_xi,Nouveaux_points)
  PRED_RGASP_gamma <-  predict(OBJET_RGASP_gamma,Nouveaux_points)
  PRED_RGASP_approx <-  predict(OBJET_RGASP_approx,Nouveaux_points)

  MATRICE_ARGMAX_VRAISEMBLANCE_INVERSE <- solve(MATRICE_ARGMAX_VRAISEMBLANCE)
  #MATRICE_RobustGaSP_xi_INVERSE <- solve(MATRICE_RobustGaSP_xi)
  #MATRICE_RobustGaSP_gamma_INVERSE <- solve(MATRICE_RobustGaSP_gamma)
  #MATRICE_RobustGaSP_approx_INVERSE <- solve(MATRICE_RobustGaSP_approx)
  MATRICE_MODE_POSTERIOR_INVERSE <- solve(MATRICE_MODE_POSTERIOR)
  MATRICE_NOUVEAUX_ARGMAX_VRAISEMBLANCE <- 1 
  #MATRICE_NOUVEAUX_RobustGaSP_xi <- 1 
  #MATRICE_NOUVEAUX_RobustGaSP_gamma <- 1 
  #MATRICE_NOUVEAUX_RobustGaSP_approx <- 1 
...
#Prediction_RobustGaSP_xi <- t(y_connus) %*% MATRICE_RobustGaSP_xi_INVERSE %*% CORREL_CONNUS_NOUVEAUX_RobustGaSP_xi + Moyenne_marginale
#Prediction_RobustGaSP_gamma <- t(y_connus) %*% MATRICE_RobustGaSP_gamma_INVERSE %*% CORREL_CONNUS_NOUVEAUX_RobustGaSP_gamma + Moyenne_marginale
#Prediction_RobustGaSP_approx <- t(y_connus) %*% MATRICE_RobustGaSP_approx_INVERSE %*% CORREL_CONNUS_NOUVEAUX_RobustGaSP_approx + Moyenne_marginale
...
Prediction_rgasp_xi <- PRED_RGASP_xi$mean
Prediction_rgasp_gamma <- PRED_RGASP_gamma$mean
Prediction_rgasp_approx <- PRED_RGASP_approx$mean
...
#Ecart_prediction_RobustGaSP_xi_moyenne_conditionnelle_juste <- sum( (Prediction_RobustGaSP_xi - Moyenne_conditionnelle_juste)*(Prediction_RobustGaSP_xi - Moyenne_conditionnelle_juste) )
#Ecart_prediction_RobustGaSP_gamma_moyenne_conditionnelle_juste <- sum( (Prediction_RobustGaSP_gamma - Moyenne_conditionnelle_juste)*(Prediction_RobustGaSP_gamma - Moyenne_conditionnelle_juste) )
#Ecart_prediction_RobustGaSP_approx_moyenne_conditionnelle_juste <- sum( (Prediction_RobustGaSP_approx - Moyenne_conditionnelle_juste)*(Prediction_RobustGaSP_approx - Moyenne_conditionnelle_juste) )
...
Ecart_prediction_rgasp_xi_moyenne_conditionnelle_juste <- sum( (Prediction_rgasp_xi - Moyenne_conditionnelle_juste)*(Prediction_rgasp_xi - Moyenne_conditionnelle_juste) )
Ecart_prediction_rgasp_gamma_moyenne_conditionnelle_juste <- sum( (Prediction_rgasp_gamma - Moyenne_conditionnelle_juste)*(Prediction_rgasp_gamma - Moyenne_conditionnelle_juste) )
Ecart_prediction_rgasp_approx_moyenne_conditionnelle_juste <- sum( (Prediction_rgasp_approx - Moyenne_conditionnelle_juste)*(Prediction_rgasp_approx - Moyenne_conditionnelle_juste) )
    ...
    #Ecart_prediction_RobustGaSP_xi <- sum( (Prediction_RobustGaSP_xi - Valeurs_nouveaux_points)*(Prediction_RobustGaSP_xi - Valeurs_nouveaux_points) )
    #Ecart_prediction_RobustGaSP_gamma <- sum( (Prediction_RobustGaSP_gamma - Valeurs_nouveaux_points)*(Prediction_RobustGaSP_gamma - Valeurs_nouveaux_points) )
    #Ecart_prediction_RobustGaSP_approx <- sum( (Prediction_RobustGaSP_approx - Valeurs_nouveaux_points)*(Prediction_RobustGaSP_approx - Valeurs_nouveaux_points) )
    ...
    Ecart_prediction_rgasp_xi <- sum( (Prediction_rgasp_xi - Valeurs_nouveaux_points)*(Prediction_rgasp_xi - Valeurs_nouveaux_points) )
    Ecart_prediction_rgasp_gamma <- sum( (Prediction_rgasp_gamma - Valeurs_nouveaux_points)*(Prediction_rgasp_gamma - Valeurs_nouveaux_points) )
    Ecart_prediction_rgasp_approx <- sum( (Prediction_rgasp_approx - Valeurs_nouveaux_points)*(Prediction_rgasp_xi - Valeurs_nouveaux_points) )
...
#Estimation_sigma_carre_Robust_GaSP_xi <-  c( t(y_connus) %*% MATRICE_Robust_GaSP_xi_INVERSE %*% y_connus / length(y_connus) )
#print(paste("Estimation de sigma^2 (Robust_GaSP avec parametre xi) : ",Estimation_sigma_carre_Robust_GaSP_xi))
#Variance_conditionnelle_Robust_GaSP_xi <-  Estimation_sigma_carre_Robust_GaSP_xi * ( MATRICE_NOUVEAUX_Robust_GaSP_xi - t(CORREL_CONNUS_NOUVEAUX_Robust_GaSP_xi) %*% MATRICE_Robust_GaSP_xi_INVERSE %*% CORREL_CONNUS_NOUVEAUX_Robust_GaSP_xi )

#Estimation_sigma_carre_Robust_GaSP_gamma <-  c( t(y_connus) %*% MATRICE_Robust_GaSP_gamma_INVERSE %*% y_connus / length(y_connus) )
#print(paste("Estimation de sigma^2 (Robust_GaSP avec parametre gamma) : ",Estimation_sigma_carre_Robust_GaSP_gamma))
#Variance_conditionnelle_Robust_GaSP_gamma <-  Estimation_sigma_carre_Robust_GaSP_gamma * ( MATRICE_NOUVEAUX_Robust_GaSP_gamma - t(CORREL_CONNUS_NOUVEAUX_Robust_GaSP_gamma) %*% MATRICE_Robust_GaSP_gamma_INVERSE %*% CORREL_CONNUS_NOUVEAUX_Robust_GaSP_gamma )

#Estimation_sigma_carre_Robust_GaSP_approx <-  c( t(y_connus) %*% MATRICE_Robust_GaSP_approx_INVERSE %*% y_connus / length(y_connus) )
#print(paste("Estimation de sigma^2 (Robust_GaSP : Jointly Robust Prior) : ",Estimation_sigma_carre_Robust_GaSP_approx))
#Variance_conditionnelle_Robust_GaSP_approx <-  Estimation_sigma_carre_Robust_GaSP_approx * ( MATRICE_NOUVEAUX_Robust_GaSP_approx - t(CORREL_CONNUS_NOUVEAUX_Robust_GaSP_approx) %*% MATRICE_Robust_GaSP_approx_INVERSE %*% CORREL_CONNUS_NOUVEAUX_Robust_GaSP_approx )
...
#Intervalle_pari_Robust_GaSP_xi <- rbind(Prediction_Robust_GaSP_xi - QNORM * sqrt(diag(Variance_conditionnelle_Robust_GaSP_xi)), Prediction_Robust_GaSP_xi + QNORM * sqrt(diag(Variance_conditionnelle_Robust_GaSP_xi)))
#Longueur_intervalle_pari_Robust_GaSP_xi <- Intervalle_pari_Robust_GaSP_xi[2,] - Intervalle_pari_Robust_GaSP_xi[1,]
#Longueur_moyenne_intervalle_pari_Robust_GaSP_xi<- mean(Longueur_intervalle_pari_Robust_GaSP_xi)
#Appartient_intervalle_pari_Robust_GaSP_xi <- (Intervalle_pari_Robust_GaSP_xi[1,] <= Valeurs_nouveaux_points)*(Intervalle_pari_Robust_GaSP_xi[2,] >= Valeurs_nouveaux_points)
#Frequence_appartient_intervalle_pari_Robust_GaSP_xi <- sum(Appartient_intervalle_pari_Robust_GaSP_xi)/CARDINAL_ENSEMBLE_TEST

#Intervalle_pari_Robust_GaSP_gamma <- rbind(Prediction_Robust_GaSP_gamma - QNORM * sqrt(diag(Variance_conditionnelle_Robust_GaSP_gamma)), Prediction_Robust_GaSP_gamma + QNORM * sqrt(diag(Variance_conditionnelle_Robust_GaSP_gamma)))
#Longueur_intervalle_pari_Robust_GaSP_gamma <- Intervalle_pari_Robust_GaSP_gamma[2,] - Intervalle_pari_Robust_GaSP_gamma[1,]
#Longueur_moyenne_intervalle_pari_Robust_GaSP_gamma<- mean(Longueur_intervalle_pari_Robust_GaSP_gamma)
#Appartient_intervalle_pari_Robust_GaSP_gamma <- (Intervalle_pari_Robust_GaSP_gamma[1,] <= Valeurs_nouveaux_points)*(Intervalle_pari_Robust_GaSP_gamma[2,] >= Valeurs_nouveaux_points)
#Frequence_appartient_intervalle_pari_Robust_GaSP_gamma <- sum(Appartient_intervalle_pari_Robust_GaSP_gamma)/CARDINAL_ENSEMBLE_TEST

#Intervalle_pari_Robust_GaSP_approx <- rbind(Prediction_Robust_GaSP_approx - QNORM * sqrt(diag(Variance_conditionnelle_Robust_GaSP_approx)), Prediction_Robust_GaSP_approx + QNORM * sqrt(diag(Variance_conditionnelle_Robust_GaSP_approx)))
#Longueur_intervalle_pari_Robust_GaSP_approx <- Intervalle_pari_Robust_GaSP_approx[2,] - Intervalle_pari_Robust_GaSP_approx[1,]
#Longueur_moyenne_intervalle_pari_Robust_GaSP_approx<- mean(Longueur_intervalle_pari_Robust_GaSP_approx)
#Appartient_intervalle_pari_Robust_GaSP_approx <- (Intervalle_pari_Robust_GaSP_approx[1,] <= Valeurs_nouveaux_points)*(Intervalle_pari_Robust_GaSP_approx[2,] >= Valeurs_nouveaux_points)
#Frequence_appartient_intervalle_pari_Robust_GaSP_approx <- sum(Appartient_intervalle_pari_Robust_GaSP_approx)/CARDINAL_ENSEMBLE_TEST
...
Estimation_sigma_carre_rgasp_xi <- OBJET_RGASP_xi@sigma2_hat
print(paste("Estimation de sigma^2 (Robust_GaSP avec parametre xi) : ",Estimation_sigma_carre_rgasp_xi))

Estimation_sigma_carre_rgasp_gamma <- OBJET_RGASP_gamma@sigma2_hat
print(paste("Estimation de sigma^2 (Robust_GaSP avec parametre gamma) : ",Estimation_sigma_carre_rgasp_gamma))

Estimation_sigma_carre_rgasp_approx <- OBJET_RGASP_approx@sigma2_hat
print(paste("Estimation de sigma^2 (Robust_GaSP : Jointly Robust Prior) : ",Estimation_sigma_carre_rgasp_approx))


Intervalle_pari_95_rgasp_xi <- rbind(PRED_RGASP_xi$lower95, PRED_RGASP_xi$upper95)
Longueur_intervalle_pari_95_rgasp_xi <- Intervalle_pari_95_rgasp_xi[2,] - Intervalle_pari_95_rgasp_xi[1,]
Longueur_moyenne_intervalle_pari_95_rgasp_xi<- mean(Longueur_intervalle_pari_95_rgasp_xi)
Appartient_intervalle_pari_95_rgasp_xi <- (Intervalle_pari_95_rgasp_xi[1,] <= Valeurs_nouveaux_points)*(Intervalle_pari_95_rgasp_xi[2,] >= Valeurs_nouveaux_points)
Frequence_appartient_intervalle_pari_95_rgasp_xi <- sum(Appartient_intervalle_pari_95_rgasp_xi)/CARDINAL_ENSEMBLE_TEST

Intervalle_pari_95_rgasp_gamma <- rbind(PRED_RGASP_gamma$lower95, PRED_RGASP_gamma$upper95)
Longueur_intervalle_pari_95_rgasp_gamma <- Intervalle_pari_95_rgasp_gamma[2,] - Intervalle_pari_95_rgasp_gamma[1,]
Longueur_moyenne_intervalle_pari_95_rgasp_gamma<- mean(Longueur_intervalle_pari_95_rgasp_gamma)
Appartient_intervalle_pari_95_rgasp_gamma <- (Intervalle_pari_95_rgasp_gamma[1,] <= Valeurs_nouveaux_points)*(Intervalle_pari_95_rgasp_gamma[2,] >= Valeurs_nouveaux_points)
Frequence_appartient_intervalle_pari_95_rgasp_gamma <- sum(Appartient_intervalle_pari_95_rgasp_gamma)/CARDINAL_ENSEMBLE_TEST

Intervalle_pari_95_rgasp_approx <- rbind(PRED_RGASP_approx$lower95, PRED_RGASP_approx$upper95)
Longueur_intervalle_pari_95_rgasp_approx <- Intervalle_pari_95_rgasp_approx[2,] - Intervalle_pari_95_rgasp_approx[1,]
Longueur_moyenne_intervalle_pari_95_rgasp_approx<- mean(Longueur_intervalle_pari_95_rgasp_approx)
Appartient_intervalle_pari_95_rgasp_approx <- (Intervalle_pari_95_rgasp_approx[1,] <= Valeurs_nouveaux_points)*(Intervalle_pari_95_rgasp_approx[2,] >= Valeurs_nouveaux_points)
Frequence_appartient_intervalle_pari_95_rgasp_approx <- sum(Appartient_intervalle_pari_95_rgasp_approx)/CARDINAL_ENSEMBLE_TEST
...
Longueurs_moyennes_intervalles_pari <- c(Longueur_moyenne_intervalle_pari_juste, Longueur_moyenne_intervalle_pari_argmax_vraisemblance, Longueur_moyenne_intervalle_pari_mode_posterior, Longueur_moyenne_intervalle_pari_full_bayesien_exact, Longueur_moyenne_intervalle_pari_full_bayesien, Longueur_moyenne_intervalle_pari_95_rgasp_xi, Longueur_moyenne_intervalle_pari_95_rgasp_gamma, Longueur_moyenne_intervalle_pari_95_rgasp_approx)

Longueurs_moyennes_intervalles_pari_normalisees <- Longueurs_moyennes_intervalles_pari / AMPLITUDE_OBSERVEE

Frequences_appartient_intervalle_pari <- c(Frequence_appartient_intervalle_pari_juste, Frequence_appartient_intervalle_pari_argmax_vraisemblance, Frequence_appartient_intervalle_pari_mode_posterior, Frequence_appartient_intervalle_pari_full_bayesien_exact, Frequence_appartient_intervalle_pari_full_bayesien, Frequence_appartient_intervalle_pari_95_rgasp_xi, Frequence_appartient_intervalle_pari_95_rgasp_gamma, Frequence_appartient_intervalle_pari_95_rgasp_approx)

Estimations_sigma_carre <- c(Estimation_sigma_carre_argmax_vraisemblance,Estimation_sigma_carre_mode_posterior, Estimation_sigma_carre_rgasp_xi, Estimation_sigma_carre_rgasp_gamma, Estimation_sigma_carre_rgasp_approx)
...
Ecart_prediction <- c(Ecart_prediction_argmax_vraisemblance, Ecart_prediction_mode_posterior, Ecart_prediction_bayesienne, Ecart_prediction_rgasp_xi, Ecart_prediction_rgasp_gamma, Ecart_prediction_rgasp_approx)
