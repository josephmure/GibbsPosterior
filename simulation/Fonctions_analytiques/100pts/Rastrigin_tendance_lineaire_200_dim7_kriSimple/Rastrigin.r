...
{
	sum(vecteur_point * vecteur_point - 10 * cos(2*pi*vecteur_point) + 10) + 200 * sum(vecteur_point) ## ce dernier terme est artificiellement ajoute pour rendre la tendance lineaire pertinente
}
