...
list(ECART_PREDICTION = Ecart_prediction, ECART_PREDICTION_NORMALISE = Ecart_prediction_normalise, ESTIMATIONS_SIGMA_CARRE = Estimations_sigma_carre, FREQUENCES_APPARTIENT_INTERVALLE_PARI = Frequences_appartient_intervalle_pari, LONGUEURS_MOYENNES_INTERVALLES_PARI = Longueurs_moyennes_intervalles_pari, LONGUEURS_MOYENNES_INTERVALLES_PARI_NORMALISEES = Longueurs_moyennes_intervalles_pari_normalisees)
