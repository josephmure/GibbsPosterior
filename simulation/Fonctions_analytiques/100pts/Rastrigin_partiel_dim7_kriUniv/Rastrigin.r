...
{
	sum(vecteur_point[-1] * vecteur_point[-1] - 10 * cos(2*pi*vecteur_point[-1]) + 10) + 100 * sum(vecteur_point) ## ce dernier terme est artificiellement ajoute pour rendre la tendance lineaire pertinente
}
